  ...
  return (
    <>
        <div className='layout'>
            ...
            <div>
                <p className='header-paragraph'>Primer Renacimiento, o Renacimiento primitivo, o Renacimiento temprano o Renacimiento inicial o Prerrenacimiento…
                    ...
                    En el proto-renacimiento estamos entre dos mundos. Estamos en el gótico (recordemos que este es un nombre a posteriori, pues para los renacentistas este era un arte de bárbaros, de godos), pero se empieza a sentir el Quattrocento.</p>
            </div>
